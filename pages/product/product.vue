	...
	<view class="container">
		<view class="carousel">
			<swiper indicator-dots circular=true duration="400">
				<swiper-item class="swiper-item" v-for="(item,index) in arr2" :key="index">
		...
		<view class="introduce-section">
			...
			<br>
			<text class="title">{{arr1.title}}</text>
			<br>
			<text class="title2">{{arr1.salePoint}}</text>
		</view>
		...
		<view class="eva-section">
			...
			<view class="eva-box" v-for="item in arr3" keys="item">
				<image class="portrait" :src="item.userPic" mode=""></image>
				<view class="right">
					<text class="name">{{item.userName}}</text>
					<text class="con">{{item.text}}</text>
					<view class="bot">
						<text class="attr">{{item.product}}</text>
		...
		<view class="detail-desc">
			<view class="xinxi">
				<view class="header_li" v-for="item in arr4" :keys="item">
					<text class="li_a1">{{ item.title.replace("\n", "") }}</text>
	...
	export default {
		...
		methods: {
			async godetail(id) {
				...
				this.arr1 = detail.data[0]
				console.log(this.arr1);
				this.arr2 = JSON.parse(this.arr1.imgs)
				this.arr3 = JSON.parse(this.arr1.comment)
